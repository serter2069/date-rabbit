...
export const scenarios: TestScenario[] = [
...

  {
    ...
    description: 'Click Find Companions → navigates to login (seeker) → OTP → logged in as seeker',
    phase: 1,
    ...
    steps: [
      ...
      { action: 'screenshot', value: '02a-login-seeker' },
      ...
      { action: 'wait', timeout: 2000 },
      { action: 'screenshot', value: '02b-otp' },
      ...
      { action: 'wait', timeout: 3000 },
      { action: 'screenshot', value: '02c-logged-in-seeker' },
...

  {
    ...
    description: 'Click Become Companion → register (companion) → companion onboarding',
    phase: 1,
    ...
    steps: [
      ...
      { action: 'wait', timeout: 1500 },
      { action: 'screenshot', value: '03a-register-companion' },
      ...
      { action: 'click', target: selectors.otpVerify },
      { action: 'wait', timeout: 3000 },
      { action: 'screenshot', value: '03b-logged-in-companion' },
    ],
  },
