...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 36, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text, marginBottom: 8 },
  subtitle: { fontSize: 16, color: colors.textMuted, marginBottom: 40 },
  optionsRow: { flexDirection: 'row', gap: 12, marginBottom: 40 },
  option: { flex: 1, paddingVertical: 24, alignItems: 'center', borderWidth: 2, borderColor: colors.border, backgroundColor: colors.surface, shadowOffset: { width: 3, height: 3 }, shadowColor: colors.shadow, shadowOpacity: 1, shadowRadius: 0 },
  optionSelected: { backgroundColor: colors.accent },
  optionText: { fontSize: 24, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text },
  optionTextSelected: { color: colors.text },
  button: { backgroundColor: colors.primary, borderWidth: 2, borderColor: colors.border, paddingVertical: 18, alignItems: 'center', shadowOffset: { width: 4, height: 4 }, shadowColor: colors.shadow, shadowOpacity: 1, shadowRadius: 0 },
  buttonDisabled: { opacity: 0.6 },
  buttonText: { fontSize: 20, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.white },
  sentCard: { backgroundColor: colors.primaryLight, borderWidth: 2, borderColor: colors.border, padding: 24, alignItems: 'center', shadowOffset: { width: 3, height: 3 }, shadowColor: colors.shadow, shadowOpacity: 1, shadowRadius: 0 },
  sentText: { fontSize: 22, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text },
  sentSubtext: { fontSize: 14, color: colors.text, marginTop: 8, textAlign: 'center' },
