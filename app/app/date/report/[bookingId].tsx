...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 32, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text, marginBottom: 32 },
  sectionLabel: { fontSize: 14, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text, marginBottom: 12, textTransform: 'uppercase', letterSpacing: 1 },
  typeOption: { borderWidth: 2, borderColor: colors.border, padding: 14, marginBottom: 8, backgroundColor: colors.surface, shadowOffset: { width: 2, height: 2 }, shadowColor: colors.shadow, shadowOpacity: 1, shadowRadius: 0 },
  ...
  textarea: { borderWidth: 2, borderColor: colors.border, backgroundColor: colors.surface, padding: 14, fontSize: 15, minHeight: 120, marginBottom: 32 },
  submitBtn: { backgroundColor: colors.primary, borderWidth: 2, borderColor: colors.border, paddingVertical: 18, alignItems: 'center', shadowOffset: { width: 4, height: 4 }, shadowColor: colors.shadow, shadowOpacity: 1, shadowRadius: 0 },
  ...
  successCard: { backgroundColor: colors.accent, borderWidth: 2, borderColor: colors.border, padding: 32, alignItems: 'center', shadowOffset: { width: 4, height: 4 }, shadowColor: colors.shadow, shadowOpacity: 1, shadowRadius: 0 },
  successText: { fontSize: 24, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text },
  successSubtext: { fontSize: 15, color: colors.text, marginTop: 8, textAlign: 'center' },
});
