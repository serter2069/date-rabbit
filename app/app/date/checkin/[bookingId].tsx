...
const styles = StyleSheet.create({
  ...
  locationText: { fontSize: 18, fontFamily: typography.fonts.heading, fontWeight: '700', color: '#000' },
  ...
  stepBadgeText: { fontSize: 12, fontFamily: typography.fonts.heading, fontWeight: '700', color: '#000' },
  stepTitle: { fontSize: 18, fontFamily: typography.fonts.heading, fontWeight: '700', color: '#000' },
  ...
  retakeBtnText: { fontSize: 14, fontFamily: typography.fonts.heading, fontWeight: '700', color: '#000' },
  cameraBtn: { backgroundColor: colors.primaryLight, borderWidth: 2, borderColor: '#000', paddingVertical: 14, alignItems: 'center', shadowOffset: { width: 3, height: 3 }, shadowColor: '#000', shadowOpacity: 1, shadowRadius: 0 },
  ...
  waitingCard: { backgroundColor: colors.primaryLight, borderWidth: 2, borderColor: '#000', padding: 20, alignItems: 'center', shadowOffset: { width: 3, height: 3 }, shadowColor: '#000', shadowOpacity: 1, shadowRadius: 0, marginBottom: 24 },
  waitingText: { fontSize: 20, fontFamily: typography.fonts.heading, fontWeight: '700', color: '#000' },
