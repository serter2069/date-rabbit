...
const styles = StyleSheet.create({
  ...
  title: { fontSize: typography.sizes.display, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text, lineHeight: 48, marginBottom: 24 },
  ...
  locationLabel: { fontSize: typography.sizes.xs, fontFamily: typography.fonts.heading, fontWeight: '700', textTransform: 'uppercase', color: colors.text, marginBottom: 4 },
  locationText: { fontSize: typography.sizes.lg, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text },
  ...
  stepBadgeText: { fontSize: typography.sizes.xs, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text },
  stepTitle: { fontSize: typography.sizes.lg, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text },
  stepDesc: { fontSize: typography.sizes.sm, color: colors.textMuted, marginBottom: 14, marginLeft: 38 },
  ...
  uploadingText: { fontSize: typography.sizes.sm, fontFamily: typography.fonts.heading, color: colors.textMuted },
  uploadDoneText: { fontSize: typography.sizes.sm, fontFamily: typography.fonts.heading, color: colors.success },
  uploadFailText: { fontSize: typography.sizes.sm, fontFamily: typography.fonts.heading, color: colors.error, marginBottom: 6 },
  ...
  retakeBtnText: { fontSize: typography.sizes.sm, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text },
  ...
  cameraBtnText: { fontSize: typography.sizes.md, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text },
  ...
  locationBtnText: { fontSize: typography.sizes.md, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text },
  locationDoneRow: { backgroundColor: colors.background, borderWidth: 1, borderColor: colors.borderLight, padding: 10 },
  locationDoneText: { fontSize: typography.sizes.sm, fontFamily: typography.fonts.heading, color: colors.text },
  ...
  checkinBtnText: { fontSize: typography.sizes.lg, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.white },
  ...
  waitingText: { fontSize: typography.sizes.lg, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.text },
  waitingSubtext: { fontSize: typography.sizes.sm, color: colors.text, marginTop: 8, textAlign: 'center' },
  ...
  statusName: { fontSize: typography.sizes.sm, fontFamily: typography.fonts.heading, marginLeft: 6, color: colors.text },
  errorText: { color: colors.primary, fontSize: typography.sizes.sm, marginTop: 8, textAlign: 'center', marginBottom: 8 },
});
