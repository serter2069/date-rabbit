...
const styles = StyleSheet.create({
  ...
  uploadDoneText: { fontSize: 13, fontFamily: typography.fonts.heading, color: '#16a34a' },
  uploadFailText: { fontSize: 13, fontFamily: typography.fonts.heading, color: '#dc2626', marginBottom: 6 },
