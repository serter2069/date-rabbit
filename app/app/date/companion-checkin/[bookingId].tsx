...
export default function CompanionCheckinScreen() {
  ...
  // Poll every 5 seconds after check-in, waiting for seeker
  useEffect(() => {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.statusRow}>
          ...
          <Text style={styles.statusName}>{booking?.seeker?.name ?? 'Guest'}</Text>
        </View>
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  uploadDoneText: { fontSize: 13, fontFamily: typography.fonts.heading, color: colors.successStrong },
  ...
  checkinBtnText: { fontSize: 20, fontFamily: typography.fonts.heading, fontWeight: '700', color: colors.textInverse },
